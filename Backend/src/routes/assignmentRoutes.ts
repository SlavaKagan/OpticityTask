...
router.delete('/assignments/:id/descriptions/:descriptionIndex', authenticateToken, (req, res) => assignmentController.deleteDescription(req, res));
router.post('/assignments/:id/descriptions', authenticateToken, (req, res) => assignmentController.addDescription(req, res));
